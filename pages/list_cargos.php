...
<head>
	...
	<title>Gerenciar Cargos | Sistema de Controle</title>
	...
	<div id="corpo">
        <div id="conteudo">
            <h2>Gerenciar Cargos</h2>
               <table width="100%" style="margin-top:5px">
                   ...
                   $inicio     = ($quantidade * $pagina) - $quantidade;
                       ...
                       $sql = mysql_query("SELECT id, nome FROM cargos ORDER BY nome ASC LIMIT $inicio, $$quantidade");
                   while($ln = mysql_fetch_array($sql)){
                   ?>
                   <tr>
                       <td><?php echo $ln['nome']; ?></td>
                       <td><a href="edit_cargos.php?id=<?php echo $ln['id'];?>">Editar</a></td>
            ...
            <div id="paginacao">
                ...
                $sqlTotal   = "SELECT id FROM cargos";
                //Executa o SQL
            ...
            <?php
                if(isset($_GET['id'])){
                     ...
                     if($remove){
                         echo '<script>alert("Membro apagado com sucesso");location.href="list_cargos.php";</script>';
                     }else{
                         echo '<script>alert("problema ao apagar membro.");location.href="list_cargos.php";</script>';
                     }
                }
            ?>
        </div><!--conteudo-->
